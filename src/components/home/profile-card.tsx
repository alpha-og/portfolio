...
const ProfileCard = () => {
  return (
    <motion.div
      ...
      className="p-6 row-span-3 col-span-1 flex flex-col justify-start items-start gap-6 rounded-xl glass sm:row-span-2 lg:row-span-1 lg:col-span-3 xl:gap-8 2xl:gap-10 2xl:p-10 ease-in-out duration-300"
    >
